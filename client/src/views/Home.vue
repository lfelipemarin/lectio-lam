        ...
        <v-card class="mt-4 mx-auto">
          ...
          <v-card-text class="pt-0">
            ...
            <div class="subheading font-weight-light grey--text text-wrap">
              ...
              <v-btn outlined small color="primary" to="/lectio" class="mt-2"
                >ve a hacer la lectio</v-btn
              >
            </div>
...
export default {
  ...
  methods: {
    ...
    beautyDate(date) {
      return `${this.$moment(date).format("D")} de ${this.$moment(date).format(
        "MMM"
      )} de ${this.$moment(date).format("YYYY")}`;
    },
  },
  computed: {
