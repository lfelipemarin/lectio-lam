        ...
        <template>
          <v-card class="mx-auto" outlined>
            <v-list-item three-line>
              ...
              <v-list-item-avatar
                v-if="showImage(saintInfo.image_links)[0]"
                @click="dialog = true"
                tile
                size="80"
                color="grey"
            ...
            <v-list-item>
              <v-list-item-content ref="saintBio" v-html="cleanText(saintInfo.bio)"> </v-list-item-content>
            </v-list-item>
            <v-card-actions>
          ...
          <v-dialog v-model="dialog" max-width="500">
            <v-card>
              <v-row align="center" justify="center">
                <v-img
                  :src="showImage(saintInfo.image_links)[0]"
                  :lazy-src="showImage(saintInfo.image_links)[0]"
                  aspect-ratio="1"
...
export default {
  ...
  methods: {
    ...
    addSaintToFavorites(saint) {
      ...
      lectioService
        .saveFavoriteSaint(saintToSave, user)
        .then(() => {
