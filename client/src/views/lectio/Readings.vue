    ...
    <v-row class="justify-center">
      ...
      <v-col cols="9">
        <v-list-item>
          ...
          <v-list-item-content>
            <v-list-item-title class="headline text-wrap">{{ evgDetails.data.date_displayed }} </v-list-item-title>
    ...
    <v-row>
      ...
      <v-col cols="12" v-if="evgDetails.data.commentary">
        <v-card>
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title class="headline text-wrap">Comentario de las lecturas </v-list-item-title>
              <v-list-item-subtitle class="text-wrap">{{
                evgDetails.data.commentary.author.name
              }}</v-list-item-subtitle>
              <v-list-item-subtitle class="text-wrap"
                >{{ evgDetails.data.commentary.author.short_description }}
              </v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
          <v-card-text>
...
export default {
  ...
  methods: {
      ...
      if (navigator.share) {
        navigator
          .share({
            ...
            text: `*${commentary.author.name} ${commentary.author.short_description}* ${this.cleanText(
    ...
    addReadingToFavorites(reading) {
      ...
      lectioService
        .saveFavoriteReading(readingToSave, user)
        .then(() => {
