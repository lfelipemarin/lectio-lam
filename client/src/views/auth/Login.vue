    ...
    <v-row align="center" justify="center">
      <v-col cols="12" sm="8" md="4">
        ...
        <v-card class="elevation-12" v-else>
          ...
          <div :class="['pl-4', 'caption']"
            >¿No tienes cuenta? <router-link to="/signup"> Créala aquí</router-link>.
          </div>
          <div :class="['pl-4', 'caption', !emailVerified ? '' : 'pb-4']"
            >¿Olvidaste la contraseña? <a @click="changeToVerifyEmail">Recupérala aquí</a>.
          </div>
          <div v-if="!emailVerified" class="caption pb-4 pl-4"
            >¿No te llegó el correo de verificación? <a @click="sendVerificationEmail">Enviar de nuevo</a>.
          </div>
        </v-card>
...
export default {
  ...
  data: () => ({
    ...
    password: '',
    passwordRules: [v => !!v || 'El campo Contraseña es obligatorio'],
    error: null,
    snackbar: false,
    isLoading: false,
    user: null,
      ...
      AuthenticationService.login({
        ...
        .then(user => {
          ...
          if (this.emailVerified) {
            ...
            this.snackbar = true;
            this.error =
              'Tu correo no ha sido verificado. Por favor revisa el mensaje de verificación en tu correo electrónico';
            this.isLoading = false;
